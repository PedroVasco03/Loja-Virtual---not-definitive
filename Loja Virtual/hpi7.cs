...
{
    public partial class asusx543 : Bunifu.UI.WinForms.BunifuUserControl
    {
        public asusx543()
        {
            InitializeComponent();
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            if (confirma == DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    {   peg.produtoPreco = preco;
                        MySqlCommand comando = new MySqlCommand("INSERT INTO SELECIONADOS(PRODUTOS,QUANTIDADE,PRECO,IDCLIENTE) VALUES(@PRODUTOS,@QUANTIDADE,@PRECO,@IDCLIENTE)", conector);
        ...
        private void lLbl_sobre_LinkClicked_1(object sender, LinkLabelLinkClickedEventArgs e)
        {
